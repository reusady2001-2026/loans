...
// ---------------------------------------------------------------------------
section("E1 · clean synthetic statement");
var C = F.clean(), p = T12.parseGrid(C.grid), e = C.expect;
...
section("E3 · clean synthetic statement: classified sums reconcile, in-place NOI ties");
...
section("E1 · same statement, cell / layout variants");
...
section("E1 · NOI row label variants");
...
section("E1 · below-the-line section (mortgage, depreciation, NET INCOME)");
...
section("E1 · trailing T6 / T3 / T1 period columns");
...
section("E1 · underwriting-style flat statement (GPR line, EGI total, reserves below the line)");
...
section("E1 · header / footing detection edge cases");
...
section("E1 · malformed / empty / header-less / all-text input never throws");
...
section("stable exports / other buildSetup paths");
...
// ---------------------------------------------------------------------------
section("Crest fixture (real statement)");
var CREST = path.join(__dirname, "fixtures", "crest-t12.xlsx");
if (!fs.existsSync(CREST)) {
  console.log("  skipped: fixture missing (" + CREST + ")");
} else {
  ...
  section("Crest fixture · E3 in-place NOI tie");
